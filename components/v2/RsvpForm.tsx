      ...
      <div className="relative mx-auto max-w-xl">
        ...
        {!guest || !token ? (
          ...
          <form onSubmit={handleSubmit} className="mt-10 space-y-6 border-t border-[#D4AF37]/40 pt-8">
            <p className="border-b border-[#D4AF37]/40 pb-4 text-center font-(family-name:--font-montserrat) text-xl text-[#333333]">{guest.family ? `Familia ${guest.name}` : `Sr. (Sra.) ${guest.name}`}</p>
